...
export default function CourtManagement({ companyId, toast }) {
    ...
    >      {/* Header with Add Court button */}
      ...
      >
        <motion.button 
          ...
          whileTap={{ scale: 0.95 }}
          className="group relative flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-sky-500 via-blue-500 to-indigo-600 text-white font-semibold rounded-2xl shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 transition-all duration-300 text-sm sm:text-base overflow-hidden"
        >
