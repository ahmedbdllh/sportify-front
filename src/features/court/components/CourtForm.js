        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2">
            ...
            <div className="relative">
              ...
              />              <div className={`${inputClass} flex items-center justify-center min-h-[120px] border-2 border-dashed border-white/20 hover:border-white/40 transition-colors cursor-pointer overflow-hidden`}>
                {form.image ? (
